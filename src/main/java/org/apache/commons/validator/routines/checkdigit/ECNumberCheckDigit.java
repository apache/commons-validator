 ...
 *
 * <p>
 * The European Community number (EC number) is a unique seven-digit identifier that is assigned to chemical substances. For example, the EC number of arsenic
 * is 231-148-6:
 * </p>
 *
 * <p>
 * Check digit calculation is based on <em>modulus 11</em> with digits being weighted based on their position (from left to right).
 * </p>
 *
 * <p>
 * For further information see <a href="https://en.wikipedia.org/wiki/European_Community_number">Wikipedia - EC number</a>.
 * </p>
 *
 * @since 1.9.0
 */
public final class ECNumberCheckDigit extends ModulusCheckDigit {
    ...
    /**
     * EC number consists of 3 groups of numbers separated dashes (-). Example: dexamethasone is 200-003-9
     */
