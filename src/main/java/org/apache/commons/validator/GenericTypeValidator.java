...
public class GenericTypeValidator implements Serializable {
     ...
     *
     * <p>
     * The {@link Locale} is used with {@link java.text.DateFormat}. The {@link java.text.DateFormat#setLenient(boolean)} method is set to {@code false} for
     * all.
     * </p>
     *
     * @param value  The value validation is being performed on.
     ...
     *
     * <p>
     * The pattern is used with {@link java.text.SimpleDateFormat}. If strict is true, then the length will be checked so '2/12/1999' will not pass validation
