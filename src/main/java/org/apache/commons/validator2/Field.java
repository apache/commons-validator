...
import org.apache.commons.validator2.util.ValidatorUtils;
 ...
 * &lt;field&gt; xml element.
 *
 * @see org.apache.commons.validator2.Form
 */
...
public class Field implements Cloneable, Serializable {
     ...
     */
    protected Map hVars = new ConcurrentHashMap<>(); // <String, Var>

    /**
     * Subclasses should use getMsgMap() instead.
     */
    protected Map hMsgs = new ConcurrentHashMap<>(); // <String, Msg>
    ...
    public Object clone() {
        ...
        field.hVars = ValidatorUtils.copyMap(hVars, Var.class);
        field.hMsgs = ValidatorUtils.copyMap(hMsgs, Msg.class);
