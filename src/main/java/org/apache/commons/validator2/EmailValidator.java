...
import org.apache.commons.validator2.routines.InetAddressValidator;
...
// NOT USED   private static final Pattern EMAIL_PATTERN = Pattern.compile("^(.+)@(.+)$");
    ...
    public boolean isValid(final String email) {
        return org.apache.commons.validator2.routines.EmailValidator.getInstance().isValid(email);
    }
